...
const Projects = () => {
    ...
    return (
        <div className="bg-white text-black px-5 lg:px-50 py-20 border-b border-gray-200">
            ...
            <div className="bg-blue-200 mt-8 rounded-3xl overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between px-6 lg:px-12 py-10 gap-10">
                    ...
                    <div className="relative lg:w-1/2 flex justify-center">
                        ...
                        <img
                            src={top}
                            className="absolute top-40 lg:top-42 right-0"
                            alt=""
                        />
                        <img
                            src={left}
                            className="absolute bottom-[-60px] lg:bottom-[-93px] left-0"
                            alt=""
                        />
                        <img
                            src={right}
                            className="absolute bottom-[-60px] md:bottom-[-90px] right-3 w-[220px] md:w-[300px]"
                            alt=""
                        />
                    </div>
                </div>
            ...
            <div className="bg-[#FBE8A4] mt-10 rounded-3xl overflow-hidden">
                ...
                <div className="flex flex-col-reverse lg:flex-row-reverse items-center justify-between px-6 lg:px-12 py-10 gap-10">
                    ...
                    <div className="relative lg:w-1/2 flex justify-center ">
                        ...
                        <img src={top} className="absolute top-40 lg:top-42 right-0" alt="" />
                        <img src={left} className="absolute bottom-[-60px] lg:bottom-[-93px] left-0" alt="" />
                        <img src={right} className="absolute bottom-[-60px] md:bottom-[-90px] right-3 w-[220px] md:w-[300px]" alt="" />
                    </div>
